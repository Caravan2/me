...
export class _3_4Screen extends React.Component {
  static navigationOptions = {
    title: 'Ms. Marika Dadiani',
    headerStyle: {
    ...
    return (
      ...
      <View style={styles.container}>
          ...
          <View style={styles.button}>
            <Text style={styles.buttonText}>Geo9D2</Text>
          </View>
          
          <View style={styles.button}>
            <Text style={styles.buttonText}>Geo11B1</Text>
          </View>
          
          <View style={styles.button}>
            <Text style={styles.buttonText}>Geo11A</Text>
          </View>
          
          <View style={styles.button}>
            <Text style={styles.buttonText}>Geo10F</Text>
          </View>
